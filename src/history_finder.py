...
class SearchHistory():
    def __init__(self):
        self.database = None
        self.filedirs = [
    f"C:\\Users\\{os.getlogin()}\\AppData\\Local\\Google\\Chrome\\User Data\\Default\\History",
    f"C:\\Users\\{os.getlogin()}\\AppData\\Local\\BraveSoftware\\Brave-Browser\\User Data\\Default\\History",
    f"C:\\Users\\{os.getlogin()}\\Roaming\\Opera Software\\Opera GX Stable\\History",
    f"C:\\Users\\{os.getlogin()}\\AppData\\Local\\Microsoft\\Edge\\User Data\\Default\\History"] 
